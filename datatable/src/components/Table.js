...
const Table = () => {
	...
	const [filters, setFilters] = useState({
		// global: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.EQUALS }] },
		global: { value: '', matchMode: FilterMatchMode.IN },
	...
	const onGlobalFilterChange = (e) => {
		...
		const seachjobidvalue = value.split(',').join(' ');
		const jobids = seachjobidvalue.replace(/\s\s+/g, ' ');
		_filters['global'].value = value.length ? jobids.split(' ') : null;
		setFilters(_filters);
